...
## AWS VPC definition
## CIDR - Classless inter-domain routing (CIDR) is a standard way of describing an IP address range for the network. 
## It’s a shorthand string that defines which IP addresses are allowed inside a network or a subnet.
